...
var questions = [{
    ...
    answerList: ["chief keef's \"finally rich\"", "Spice Girls' \"Spice\"", "red hot chile pepper's \"freaky stylie\"", "Metallica's \"Metallica\""],
    answer: 3
}, {
    question: "Which TV character said, “Live long and prosper”?",
    answerList: ["Lord Voldemort", "Mr Spock from Star Trek.", "Lord Farquad", "Anakin Skywalker"],
    answer: 1
}, {
    question: "The beaver is the national emblem of which country?",
    answerList: ["France", "Chile", "India", "Canada."],
    answer: 3
}, {
    question: "How many players are there in a baseball team?",
    answerList: ["one", "five", "ten", "nine"],
    answer: 3
}, {
    ...
    answerList: ["alfred", "marie", "enrique", "Johnny Appleseed"],
    answer: 0
}, {
    question: "The average human body contains how many pints of blood?",
    answerList: ["six", "twelve", "one", "nine"],
    answer: 3
}];
